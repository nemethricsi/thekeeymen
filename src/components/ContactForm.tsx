  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="group text-tk-vviolet-600 flex w-full items-center justify-center gap-2 rounded-lg bg-[#fefefe] px-4 py-2 font-bold uppercase transition-colors focus:outline-2 focus:outline-offset-3 focus:outline-[#fefefe] active:bg-[#fefefe]/75 active:outline-none disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:bg-transparent disabled:hover:text-[#fefefe]"
      >
